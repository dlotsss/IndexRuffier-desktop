...
appeal_1 = 'Спасибо за прохождение теста, ' 
appeal_2 = '!'
txt_age = 'Полных лет:'
...
level1 = 'Низкий. Срочно обратитесь ко врачу!'
level2 = 'Удовлетворительный. Обратитесь ко врачу.'
level3 = 'Средний. Пройдите осмотр.'
level4 = 'Выше среднего'
level5 = 'Высокий'
